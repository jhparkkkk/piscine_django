...
if __name__ == "__main__":
    try:
        ...
        postal_code = (list(capital_cities.keys())[list(capital_cities.values()).index(sys.argv[1])])
        print((list(states.keys())[list(states.values()).index(postal_code)]))

    except ValueError as error:
        print("Unknown capital city", file=sys.stderr)
